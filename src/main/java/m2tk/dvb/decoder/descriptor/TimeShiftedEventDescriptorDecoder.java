...
public class TimeShiftedEventDescriptorDecoder extends DescriptorDecoder
{
    public static final int TAG = 0x4F;

    public TimeShiftedEventDescriptorDecoder()
    {
        super("TimeShiftedEventDescriptorDecoder");
    }

    @Override
    public boolean isAttachable(Encoding target)
    {
        return super.isAttachable(target) && target.readUINT8(0) == TAG && target.size() >= 6;
    }
